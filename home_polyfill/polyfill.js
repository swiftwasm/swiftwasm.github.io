...
var ASM_CONSTS = [function() { const imports = { wasi_unstable: WASIPolyfill };         WebAssembly.instantiate(wasi_wasm_buffer, imports)         .then(obj => {             setInstance(obj.instance);             try {                 obj.instance.exports._start();             } catch (e) {                 if (e instanceof WASIExit) {                     handleWASIExit(e);                 } else {                     console.log(e);                 }             }         })         .catch(error => {             console.log('error! ' + error);         }); }];
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=5808;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
